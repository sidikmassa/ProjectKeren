...
<div class="mw_left_ft">
	<ul>
            ...
            <li><?php echo anchor('police/police','Private Police')?></li>
            <li><?php echo anchor('barang/carabeli','News')?></li>
            <li><?php echo anchor('payment/payment','Payment')?></li>
             	</ul>
</div>
<div class="mw_right_ft">
	<p>
		&copy; 2016 <a href=""><strong>eCommerce</strong></a>	
	</p>
</div>
