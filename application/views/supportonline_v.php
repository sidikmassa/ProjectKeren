...
/*
	$status = '';
	$id = "mgcn_sidik"; //Ubah sesuai Yahoo ID anda
	...
	if($status == $id." is ONLINE"){
		echo "<a class='sup-on' href='ymsgr:sendIM?mgcn_sidik'>Sedang Offline</a>";
	} else {
		echo "<a class='sup-off' href='ymsgr:sendIM?mgcn_sidik''>Sedang Offline</a>";
	}
*/
?>